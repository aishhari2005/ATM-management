...
public class Signup extends JFrame implements ActionListener {
    ...
    Signup() {
        ...
        int startYear = 1950;
        for (int i = 0; i < 100; i++) years[i] = String.valueOf(startYear + i);
        ...
        dayBox.setBounds(300, 240, 60, 30); add(dayBox);
        monthBox.setBounds(370, 240, 100, 30); add(monthBox);
        yearBox.setBounds(480, 240, 120, 30); add(yearBox);
        ...
        r4.setBounds(450, 390, 100, 30); add(r4);
        r5.setBounds(635, 390, 100, 30); add(r5);
